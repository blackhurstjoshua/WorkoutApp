<template>
  <div style="height: 100%">
    <div class="pa-6 green--text text--darken-2 text-h5 d-inline-flex">
      New Activity Plan
    </div>
    <v-btn class="mr-5 mt-5 float-right" outlined large color="green lighten-2" @click="save">
      Save
    </v-btn>
      ...
      <div class="pl-2 pt-6">
        <v-dialog v-model="dialog" persistent max-width="600px">
          ...
          <template v-slot:activator="{ on, attrs }">
            <v-btn class="green lighten-2" large v-bind="attrs" v-on="on">
...
export default {
  ...
  methods: {
    ...
    save: function() {
      ...
      if (this.plan.exercises.length == 0) 
        this.alert = true;
      else 
